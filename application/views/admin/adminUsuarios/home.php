                        ...
                        <tr ng-repeat="ulist in usuarios  | filter:q as results">
                            ...
                            <td class="align-middle text-center">
                                ...
                                <?php if(getPrivilegios()[0]['borrar'] == 1){ ?>
                                    <a ng-click="borraUsuario(ulist.idPersona)" ng-if="ulist.idPersona!=1" title="Eliminar"  class="btn btn-danger btn-fab btn-fab-mini btn-xs"><i class="fas fa-trash"></i></a>
                                <?php } ?>
                            </td>
                        </tr>
                    </tbody>
